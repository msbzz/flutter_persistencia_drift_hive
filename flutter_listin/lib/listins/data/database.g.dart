...
typedef $$ListinTableTableCreateCompanionBuilder = ListinTableCompanion
    Function({
  Value<int> id,
  required String name,
  required String obs,
...
typedef $$ListinTableTableUpdateCompanionBuilder = ListinTableCompanion
    Function({
  Value<int> id,
  Value<String> name,
  Value<String> obs,
...
class $$ListinTableTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ListinTableTable,
    ListinTableData,
  ...
  $$ListinTableTableTableManager(_$AppDatabase db, $ListinTableTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$ListinTableTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$ListinTableTableOrderingComposer(ComposerState(db, table)),
...
class $$ListinTableTableFilterComposer
    extends FilterComposer<_$AppDatabase, $ListinTableTable> {
  $$ListinTableTableFilterComposer(super.$state);
...
class $$ListinTableTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $ListinTableTable> {
  $$ListinTableTableOrderingComposer(super.$state);
